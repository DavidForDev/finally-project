...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->sub_Title->Size = System::Drawing::Size(119, 13);
			this->sub_Title->TabIndex = 12;
			this->sub_Title->Text = L"first you need to sign up";
			// 
			// Title
			// 
			...
			this->Title->Size = System::Drawing::Size(537, 29);
			this->Title->TabIndex = 11;
			this->Title->Text = L"Welcome to PhoneAreal, Start Registration";
			// 
			// start_btn
			// 
			...
			this->start_btn->Location = System::Drawing::Point(572, 464);
			this->start_btn->Name = L"start_btn";
			this->start_btn->Size = System::Drawing::Size(69, 30);
			...
			this->clear_btn->Location = System::Drawing::Point(450, 464);
			...
			this->repeat_password_value->UseSystemPasswordChar = true;
			// 
			// label4
			// 
