...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// person_name
			// 
			this->person_name->Anchor = static_cast<System::Windows::Forms::AnchorStyles>(((System::Windows::Forms::AnchorStyles::Top | System::Windows::Forms::AnchorStyles::Left)
			...
			// phone_number
			// 
			this->phone_number->Anchor = static_cast<System::Windows::Forms::AnchorStyles>(((System::Windows::Forms::AnchorStyles::Top | System::Windows::Forms::AnchorStyles::Left)
				| System::Windows::Forms::AnchorStyles::Right));
			...
			this->phone_number->Size = System::Drawing::Size(293, 27);
			...
			// person_country
			// 
			this->person_country->Anchor = static_cast<System::Windows::Forms::AnchorStyles>(((System::Windows::Forms::AnchorStyles::Top | System::Windows::Forms::AnchorStyles::Left)
				| System::Windows::Forms::AnchorStyles::Right));
			...
			this->person_country->Size = System::Drawing::Size(293, 27);
			...
			// person_address
			// 
			this->person_address->Anchor = static_cast<System::Windows::Forms::AnchorStyles>(((System::Windows::Forms::AnchorStyles::Top | System::Windows::Forms::AnchorStyles::Left)
				| System::Windows::Forms::AnchorStyles::Right));
			...
			this->person_address->Size = System::Drawing::Size(291, 27);
			...
			this->addNumber_btn->Location = System::Drawing::Point(134, 334);
			...
			this->numbers_grid->Columns->AddRange(gcnew cli::array< System::Windows::Forms::DataGridViewColumn^  >(4) {
			...
			this->numbers_grid->Size = System::Drawing::Size(509, 216);
			...
			// phoneNumber
			// 
			this->phoneNumber->HeaderText = L"number";
			...
			this->ClientSize = System::Drawing::Size(849, 369);
...
#pragma endregion
	...
	private: System::Void addNumber_btn_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		MessageBox::Show(user->id.ToString(), "hello");
		...
		try {
			...
			if (result > 0) {
				...
				GetData("SELECT name, phoneNumber, country, address FROM phoneBook");
				return;
			}
		}
		catch (Exception^ e) {
